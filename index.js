...
async function handleEvent(event) {
  console.log(event);
  if (event.type === "message" && (event.message.type === "sticker" || event.message.type === "image" || event.message.type === "video" || event.message.type === "audio" || event.message.type === "file")) {
                ...
                "contents": [
                  ...
                  },
                  {
                    ...
                    "action": {
                      ...
                      "data": "ขอหนังสือรับรองการเป็นสมาชิก",
                      "displayText": "ขอหนังสือรับรองการเป็นสมาชิก"
                    },
                    "style": "primary",
                    "height": "sm",
                    "margin": "lg"
    ...
    if (event.postback.data === "ขอหนังสือรับรองการเป็นสมาชิก") {
      await client.replyMessage({
        replyToken: event.replyToken,
        messages: [
          {
            type: "text",
            text: "เจ้าหน้าที่สมาคมจะส่งไฟล์ให้ภายใน 1-2 วันทำการ ขอบคุณครับ",
          }
        ]
      });
    }
